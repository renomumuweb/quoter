...
private struct PDFCopy {
    ...
    init(language: AppLanguage) {
        contractSubtitle = AppLanguage.localizedString("Contract PDF generated by Quoter", language: language)
        contractDetails = AppLanguage.localizedString("Contract Details", language: language)
        quoteSubtitle = AppLanguage.localizedString("Quote PDF generated by Quoter", language: language)
        quoteDetails = AppLanguage.localizedString("Quote Details", language: language)
        customerSignature = AppLanguage.localizedString("Customer Signature: __________________________", language: language)
        companySignature = AppLanguage.localizedString("Company Signature: __________________________", language: language)
    }
}
